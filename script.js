...
var n1 = L.geoJSON(n1, {
 ...
 var n11 = L.geoJSON(zona_geojson_b, {
	style: style2,
    onEachFeature: function (feature, layer) {
    layer.bindPopup('</h2><b><p style="color:red;">ATENCION!!</p></b>'+'</h2><b><p style="color:red;">zona de trabajo</p></b>');
  }
  }).addTo(map);
